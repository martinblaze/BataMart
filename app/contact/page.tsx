    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Serving UNIZIK Community</h2>
          <p className="text-xl text-gray-600 mb-8">We deliver across all UNIZIK campuses including:</p>
