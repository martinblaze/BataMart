...
export default function SellPage() {
  ...
  // ── University delivery areas (only the landmark dropdown is dynamic) ──────
  // Hostel/Lodge stays a free-text input — sellers type their own location.
  // Only the landmark (delivery area) is pulled from their university record
  // so it stays consistent for riders when new universities are added.
  ...
  useEffect(() => {
    ...
    // Load university delivery areas — try localStorage cache first, then API
    const loadAreas = async () => {
      try {
        ...
        // Silently fall through — landmark becomes free-text input
      } finally {
        setCheckingAuth(false)
      }
    }
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Description Tags — exactly as original */}
            <div>
            ...
            <div className="border-t pt-6">
              ...
              <div className="space-y-4">
                ...
                {/* Hostel — free text, seller types their own lodge/location */}
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">
                ...
                {/* Landmark — dropdown if university has deliveryAreas, otherwise free text */}
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">
                    Landmark / Delivery Area <span className="text-red-500">*</span>
                  </label>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    The area where the rider will come to collect this product
                  </p>
                </div>
              </div>
            </div>
